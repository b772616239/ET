    ...
    unsafe class ETModel_Entity_Binding
    {
        public static void Register(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            if (genericMethods.TryGetValue("AddComponent", out lst))
            {
                ...
                {
                    if(m.MatchGenericParameters(args, typeof(ETModel.FUIPackageComponent)))
                    {
        ...
        static StackObject* AddComponent_0(ILIntepreter __intp, StackObject* __esp, IList<object> __mStack, CLRMethod __method, bool isNewObj)
        {
            ...
            var result_of_this_method = instance_of_this_method.AddComponent<ETModel.FUIPackageComponent>();
