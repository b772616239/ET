...
namespace ETHotfix.Common
{
	...
	{	
		...
		{			
			return EntityFactory.Create<FUILoading, GObject >(Game.Scene,CreateGObject());
		}
        ...
        public static Task<FUILoading> CreateInstanceAsync()
        {
            ...
            {
                tcs.SetResult(EntityFactory.Create<FUILoading, GObject >(Game.Scene,go));
            });
		...
		{
			return EntityFactory.Create<FUILoading, GObject >(Game.Scene,go);
		}
