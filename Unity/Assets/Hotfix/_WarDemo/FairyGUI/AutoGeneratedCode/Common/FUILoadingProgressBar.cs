...
namespace ETHotfix.Common
{
	...
	{	
		...
		{			
			return EntityFactory.Create<FUILoadingProgressBar, GObject >(Game.Scene,CreateGObject());
		}
        ...
        public static Task<FUILoadingProgressBar> CreateInstanceAsync()
        {
            ...
            {
                tcs.SetResult(EntityFactory.Create<FUILoadingProgressBar, GObject >(Game.Scene,go));
            });
		...
		{
			return EntityFactory.Create<FUILoadingProgressBar, GObject >(Game.Scene,go);
		}
